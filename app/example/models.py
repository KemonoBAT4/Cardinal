...
class Example(BaseModel):
    ...
    text1 = db.Column(db.String(255), unique=False, nullable=True)
    text2 = db.Column(db.String(255), unique=False, nullable=True)
    text3 = db.Column(db.String(255), unique=False, nullable=True)
    text4 = db.Column(db.String(255), unique=False, nullable=True)
    text5 = db.Column(db.String(255), unique=False, nullable=True)
    text6 = db.Column(db.String(255), unique=False, nullable=True)
